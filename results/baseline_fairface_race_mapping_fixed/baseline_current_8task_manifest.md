...
- `results\baseline_fairface_race_mapping_fixed\gap_analysis_baseline_current_8task.csv`
- `results\baseline_fairface_race_mapping_fixed\gap_analysis_baseline_current_8task.json`
- `results\baseline_fairface_race_mapping_fixed\baseline_current_8task_manifest.json`
