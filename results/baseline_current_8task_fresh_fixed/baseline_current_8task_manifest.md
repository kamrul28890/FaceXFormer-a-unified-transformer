...
- `results\baseline_current_8task_fresh_fixed\gap_analysis_baseline_current_8task.csv`
- `results\baseline_current_8task_fresh_fixed\gap_analysis_baseline_current_8task.json`
- `results\baseline_current_8task_fresh_fixed\baseline_current_8task_manifest.json`
